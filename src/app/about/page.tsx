...
export default function About() {
  const communityFeatures = [
    ...
    },
    {
      ...
      description:
        "Get tailored anime suggestions based on your watching history and preferences.",
    },
    {
      icon: Rocket,
      title: "Latest Updates",
      description:
        "Stay informed about new releases, upcoming series, and trending anime content.",
    },
  ];
  ...
  const frequentlyAskedQuestions = [
    ...
    {
      question:
        "Is Animeverse an official or licensed anime streaming platform?",
      answer:
        ...
        <CardContent className="space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto">
              AnimeVerse is more than just a platform—it&apos;s a global
              community dedicated to celebrating the rich, diverse world of
              anime. We aim to connect fans, provide comprehensive resources,
              and create a welcoming space for anime enthusiasts of all levels.
            </p>
          </div>
